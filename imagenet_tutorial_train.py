...
# Configs
    ...
    print("4 Model loading finished.")
    ...
    checkpoint_callback = ModelCheckpoint(
        ...
        # dirpath='./checkpoints/checkpoints_imagenet_benign_new',  #############sccchange
        dirpath='./checkpoints/checkpoints_imagenet_source_adv_original_new',  #############sccchange
